...
<jsp:include page="../home/main_top.jsp"></jsp:include>
	...
	<div class="full"><br>
	<div class="title">상품수정 <i class="fas fa-tshirt"></i></div>
	<form action="/goods/update/${dto.g_code}?curPage=${curPage}" method="post">
		...
		<div>
		 ...
		 <input id="g_point" name="g_point" value="${dto.g_point}">
		  &emsp;
		 <label class="g_amount_label" for="g_amount">상품 수량</label>
		...
		<div style="float:right;">
			<input class="update_btn btn" type="submit" value="수정">
			<input class="reset_btn btn" type="reset" value="초기화">
		</div><br>
