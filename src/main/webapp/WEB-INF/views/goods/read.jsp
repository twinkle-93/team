...
<link href="/resources/css/goods/read.css" rel="stylesheet"
   type="text/css">
...
<body>
   ...
   <div style="height: 100%;">
      <div class="r_body">
         ...
         <div class="read">
            ...
            <span>${dto.g_price}</span> --%>
               ...
               <button style="width: 120px; margin-left: 30px; background: #8cd98c;" class="btn"
                  type="submit">
         ...
         <c:if test="${!empty admin}">
               <div class="buttonList">
                  ...
                  <button class="btn updateBtn" id="updateBtn">수정</button>
      ...
      <div class="re_body">
            ...
            <div>
               <span> <label for="r_star">별점</label> <span id="r_star"
                  class="r_star"> <a value="1">★</a> <a value="2">★</a> <a
                     ...
                     <span style="font-size: x-small;"> 별점을 입력해주세요.</span>
               </span>
               ...
               <span style="float: right;"> <label for="r_id">작성자</label>
         ...
         <div id="listPage" style="margin: 30px 0; text-align: center;">
