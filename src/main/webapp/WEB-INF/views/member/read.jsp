...
<jsp:include page="../home/main_top.jsp"></jsp:include>
	...
	<div style="font-size: 3em; text-align: center; margin: 40px 0; color: green;">회원 상세정보 <i class="fas fa-search"></i></div>
<br>
	<form style="margin: auto;">
		...
		<label>주소</label><span style="float:right; width:197px ;white-space: pre-wrap; margin-bottom: 0;">${dto.m_adress} ${dto.m_detailAdress}</span><br>
