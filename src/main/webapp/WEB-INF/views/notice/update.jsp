...
<div class="body">
	...
	<form role="form" method="post" action="/notice/update" autocomplete="off">
			<input type="hidden" id="n_num" name="n_num" value="${notice.n_num}" readonly/>
			...
			<fmt:formatDate value="${notice.n_regDate}" pattern="yyyy-MM-dd" /></span>
			
		<textarea rows="5" cols="50" id="n_content" name="n_content">${notice.n_content}</textarea>
		<script>	
			var ckeditor_config = {
			  resize_enaleb : false,
		...
		<div>
			...
			<input type="text" id="n_id" name="n_id" value="${notice.n_id}" readonly><br>
		</div>	
		<div class="u_btn">
