	...
	<div class="title">공지사항 <i class="fas fa-exclamation"></i></div>
		...
		<hr/>
		    ...
		    <div>
	    		...
	    		${notice.n_id}
	    		<span class="day">작성일&nbsp;
	    		<span><fmt:formatDate value="${notice.n_regDate}" pattern="yyyy-MM-dd" /></span>
	    		</span>
	    	</div>
	    <hr/><br>
	    	<div class="n_content">
	    ...
	    <c:choose>
	       ...
	       <div class="blank"></div>
	       <form id="deletePost" action="/notice/delete/${notice.n_num}" method="post"></form>
</div>   
<script type="text/javascript">
	$(document).ready(function() {
		$("#update_btn").click(function(event) {
			event.preventDefault();
			location.assign("/notice/update/${notice.n_num}");
		});
