	...
	<div class="body"
		...
		<form action="/orders/insert" method="post">
			...
			<input type="hidden" id="o_totalprice" name="o_totalprice"
				value="${map.allSum}"> <label>보유 쿠폰 할인</label>
			<button id="coupon" data-toggle="collapse" href="#couponList" aria-expanded="false">쿠폰선택</button>
			<br> <input id="couponDiscount" type="text" style="border: 0px;"> 원 할인
			...
			<br> <label>적립금 사용</label> <br> <input id="pointDiscount"
				name="o_pointDiscount" type="text" value=""> point <br>
			보유적립금<span><fmt:formatNumber pattern="###,###,###"
					value="${map.member.m_point}" />point</span> <input type="checkbox"
				id="pointAll"> 전체사용 <br>
