   ...
   <div style="margin: auto; width: 1260px; height: 100%; z-index: 5;">
      <ul>
         ...
         <c:forEach items="${map.saleList}" var="saleGoods">
            <li style="width: 400px; height: 500px; display: inline-block;">
               <a href="/goods/read/${saleGoods.g_code}?curPage=1"><img id="sale${saleGoods.g_code}" src="#" style="width: 350px; height: 400px; margin: 20px;"></a>
                  ...
                  function getAttachSale() {
                     $.getJSON("/goods/getAttach/${saleGoods.g_code}", function(result) {
                        for(var i=0; i<result.length; i++){
                           ...
                           $("img#sale${saleGoods.g_code}").attr("src", "/goods/displayFile?filename="+filename);
                        }
                     });
                  };
               });
      ...
      <ul>
         ...
         <c:forEach items="${map.regList}" var="regGoods">
            <li style="width: 400px; height: 500px; display: inline-block;">
               <a href="/goods/read/${regGoods.g_code}?curPage=1"><img id="reg${regGoods.g_code}" src="#" style="width: 350px; height: 400px; margin: 20px;"></a>
               <div style="text-align: center;">
                  <p>
                  ...
                  function getAttachReg() {
                     $.getJSON("/goods/getAttach/${regGoods.g_code}", function(result) {
                        for(var i=0; i<result.length; i++){
                           ...
                           console.log(result[i]);
                           var filename = result[i];
                           $("img#reg${regGoods.g_code}").attr("src", "/goods/displayFile?filename="+filename);
                        }
                     });
                  };
               });
