	...
	<div style="margin: auto; width: 1260px; height: 100%; z-index: 5;">
		<ul>
			...
			<c:forEach items="${map.saleList}" var="saleGoods">
				...
				<a href="/goods/read/${saleGoods.g_code}?curPage=1"><img id="${saleGoods.g_code}" style="width: 350px; height: 400px; margin: 20px;"></a>
		...
		<ul>
			...
			<c:forEach items="${map.regList}" var="regGoods">
				<li style="width: 400px; height: 500px; display: inline-block;">
					<a href="/goods/read/${regGoods.g_code}?curPage=1"><img id="${regGoods.g_code}" style="width: 350px; height: 400px; margin: 20px;"></a>
					<div style="text-align: center;">
						<p>
