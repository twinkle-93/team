...
public class ReviewDAOImpl implements ReviewDAO{
	...
	public List<ReviewDTO> listByRegDate(String r_code) {
		return session.selectList(NAMESPACE+".listByRegDate",r_code);
	}

	@Override
	public List<ReviewDTO> listByHighStar(String r_code) {
		return session.selectList(NAMESPACE+".listByHighStar", r_code);
	}

	@Override
	public List<ReviewDTO> listByLowStar(String r_code) {
		return session.selectList(NAMESPACE+".listByLowStar", r_code);
	}
