...
public class CartVO implements Serializable {
	...
	public int getC_g_point() {
		return c_g_point;
	}

	public void setC_g_point(int c_g_point) {
		this.c_g_point = c_g_point;
	}
	...
	public String toString() {
		return "CartVO [c_id=" + c_id + ", c_m_id=" + c_m_id + ", c_g_code=" + c_g_code + ", c_g_name=" + c_g_name
				+ ", c_g_price=" + c_g_price + ", c_amount=" + c_amount + ", c_g_point=" + c_g_point + "]";
	}
