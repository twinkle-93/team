...
public class OrdersDTO implements Serializable {
	...
	public OrdersDTO(String o_id, String o_name, int o_number, String[] o_code, int o_price, int o_totalprice,
	...
	public String toString() {
		return "OrdersDTO [o_id=" + o_id + ", o_name=" + o_name + ", o_number=" + o_number + ", o_code="
				+ Arrays.toString(o_code) + ", o_price=" + o_price + ", o_totalprice=" + o_totalprice + ", o_regDate="
				+ o_regDate + ", o_zipcode=" + o_zipcode + ", o_address=" + o_address + ", o_detailAddress="
				+ o_detailAddress + ", o_phone=" + o_phone + ", o_memo=" + o_memo + ", o_point="
				+ Arrays.toString(o_point) + ", o_discount=" + o_discount + ", o_paymentAmount=" + o_paymentAmount
				+ ", o_pointDiscount=" + o_pointDiscount + ", o_amount=" + Arrays.toString(o_amount) + "]";
	}
