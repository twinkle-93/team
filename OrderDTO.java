...
public class OrderDTO implements Serializable{
	...
	public OrderDTO(String o_id, int o_number, String o_code, int o_price, int totalprice, Date o_regDate,
	...
	public String toString() {
		return "OrderDTO [o_id=" + o_id + ", o_number=" + o_number + ", o_code=" + o_code + ", o_price=" + o_price
				+ ", o_totalprice=" + o_totalprice + ", o_regDate=" + o_regDate + ", o_zipcode=" + o_zipcode + ", o_adress="
				+ o_adress + ", o_detailAdress=" + o_detailAdress + "]";
	}
